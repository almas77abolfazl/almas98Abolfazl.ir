/**
 * Global site-wide constants used for SEO metadata (canonical URLs, Open Graph, JSON-LD).
...
/** Social profile URLs used in the Person JSON-LD `sameAs` array. Add real links as needed. */
