  ...
  template: `
    @if (error$ | async; as error) {
      <div class="fixed top-0 inset-x-0 bg-rose-600 px-6 py-3 text-white shadow-lg z-[60] flex justify-between items-center">
        ...
        <button (click)="clearError()" class="ml-4 text-white hover:text-rose-100 text-xl font-bold leading-none">&times;</button>
      </div>
    }
    ...
    <div class="flex h-screen overflow-hidden bg-slate-100 dark:bg-slate-950">
      ...
      <aside class="hidden lg:flex w-64 shrink-0 flex-col border-s-0 border-e border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
        <div class="flex h-16 items-center gap-2 border-b border-slate-200 px-5 dark:border-slate-800">
          ...
          <span class="text-base font-semibold text-slate-800 dark:text-slate-100">Admin Panel</span>
        </div>
      ...
      <aside
        ...
        <div class="flex h-16 items-center justify-between border-b border-slate-200 px-5 dark:border-slate-800">
          ...
          <button (click)="closeMenu()" class="rounded-lg p-2 text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800" aria-label="Close menu">
      ...
      <div class="flex min-w-0 flex-1 flex-col">
        <header class="flex h-16 items-center justify-between border-b border-slate-200 bg-white/80 px-4 backdrop-blur-md sm:px-6 dark:border-slate-800 dark:bg-slate-900/80">
          <button (click)="toggleMenu()" class="rounded-lg p-2 text-slate-600 hover:bg-slate-100 lg:hidden dark:text-slate-300 dark:hover:bg-slate-800" aria-label="Open menu">
            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
            </svg>
          </button>
          <h1 class="text-lg font-semibold text-slate-800 dark:text-slate-100 lg:hidden">Admin Panel</h1>
          <div class="flex items-center gap-2">
...
export class ShellComponent {
  ...
  nav: NavItem[] = [
    ...
    { path: '/about-me', label: 'About Me', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
    ...
    { path: '/educations', label: 'Educations', icon: 'M12 14l9-5-9-5-9 5 9 5z M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z' },
    ...
    { path: '/articles', label: 'Articles', icon: 'M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2V6a2 2 0 00-2-2z' },
    { path: '/videos', label: 'Videos', icon: 'M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z' },
    { path: '/testimonials', label: 'Testimonials', icon: 'M8 10H5a2 2 0 01-2-2V5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2zm0 0h2a2 2 0 002-2v-2a2 2 0 00-2-2H8a2 2 0 00-2 2v2a2 2 0 002 2zm0 0v6a2 2 0 002 2h2a2 2 0 002-2v-4a2 2 0 00-2-2H8z' },
    { path: '/messages', label: 'Messages', icon: 'M8 10H5a2 2 0 01-2-2V5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2zm0 0h2a2 2 0 002-2v-2a2 2 0 00-2-2H8a2 2 0 00-2 2v2a2 2 0 002 2zm0 0v6a2 2 0 002 2h2a2 2 0 002-2v-4a2 2 0 00-2-2H8z' },
  ];

  constructor(private authService: AuthService, private notificationService: NotificationService, public theme: ThemeService) {}
